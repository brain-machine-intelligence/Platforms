...
public class SpawnObject_wgan : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameObject.GetComponent<VoxelInfo_wgan>().VoxelInfoOnStart();
    ...
    public void GetEulers(int action_count, List<Vector3[]> voxelTransform, List<int> objectTypes, List<float> objectVisibility, bool collect_data)
    {
        if(!collect_data)
        {
            return;
        }
        VoxelInfo_wgan scr = gObj.GetComponent<VoxelInfo_wgan>();
