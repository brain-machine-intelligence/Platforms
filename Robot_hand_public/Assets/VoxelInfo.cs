...
public class VoxelInfo : MonoBehaviour
{
    ...
    readonly string writePath = ".\\data\\data12\\VoxelData\\";
    ...
    public void VoxelGen(List<GameObject> Obj_generated, List<List<Vector3[]>> voxelTransform, List<List<int>> objectTypes, List<List<float>> objectVisibility, bool collect_data)
    {
        if (collect_data)
        {
            ...
            List<Vector3[]> transformValsRotated = new List<Vector3[]>();
            List<int> currentObjectTypes = new List<int>();
            ...
            objectTypes.Add(currentObjectTypes);
            ...
            voxelTransform.Add(transformValsRotated);
    ...
    void CalculateObjectVisibility(List<GameObject> generated, List<Vector3> childLocalPositions, List<int> gameobjectIDs, List<Vector3[]> voxelTransform, List<List<float>> objectVisibility)
    {
        //for each object 
        ...
        List<float> ObjectVisible_degree = new List<float>();
        ...
        objectVisibility.Add(ObjectVisible_degree);
    }
